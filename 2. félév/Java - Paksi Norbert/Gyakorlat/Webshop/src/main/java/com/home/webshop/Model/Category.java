...
public class Category implements Serializable {
    ...
    public String toString() {
        return "com.home.webshop.Model.Category[ id=" + id + " ]";
    }
    ...
    public static boolean createCategory(String name) {
        ...
        try {
            StoredProcedureQuery spq = em.createStoredProcedureQuery("createCategory");
    ...
    public static boolean deleteCategory(Integer id) {
        ...
        try {
            StoredProcedureQuery spq = em.createStoredProcedureQuery("deleteCategory");
    ...
    public static boolean updateCategory(Integer id, String newName) {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.Home_Webshop_war_1.0-SNAPSHOTPU");
        EntityManager em = emf.createEntityManager();
        
        try {
            StoredProcedureQuery spq = em.createStoredProcedureQuery("updateCategory");
