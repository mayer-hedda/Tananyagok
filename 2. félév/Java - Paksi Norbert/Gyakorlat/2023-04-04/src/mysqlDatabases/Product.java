...
public class Product implements Serializable {
    ...
    public String toString() {
        return "mysqlDatabases.Product[ id=" + id + " ]";
    }
    
    
    // Saját függvények
    
    public static boolean createProduct(String name, Integer price, String category, String size) {
        // adatbázis kapcsolat példányosítás
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("2023-04-04PU");
        ...
        try {
            ...
            spq.registerStoredProcedureParameter("productPrice", Integer.class, ParameterMode.IN);
            spq.registerStoredProcedureParameter("productCategory", String.class, ParameterMode.IN);
            spq.registerStoredProcedureParameter("pizzaSize", String.class, ParameterMode.IN);
            ...
            spq.setParameter("pizzaSize", size);
            ...
            // adatbázis kapcsolta lezárása biztonsági okokból
            em.clear();
            em.close();
            emf.close();
        }
    ...
    public static boolean deleteProduct(Integer productId) {
        ...
        try {
            ...
            // paraméterek értékadása
            spq.setParameter("pId", productId);
...
//    public static boolean setProduct() {
//        
//    }
