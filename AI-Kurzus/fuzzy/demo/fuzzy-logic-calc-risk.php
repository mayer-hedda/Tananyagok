...
$x->addMember($x->getInputName(0),'inadequate',  0, 20, 40 ,MemberShipFunctionType::LINFINITY->value);
$x->addMember($x->getInputName(0),'marginal'  , 20, 50, 80 ,MemberShipFunctionType::TRIANGLE->value);
$x->addMember($x->getInputName(0),'adequate'  , 60, 80, 100,MemberShipFunctionType::RINFINITY->value);
$x->addMember($x->getInputName(1),'small', 0, 30, 70,MemberShipFunctionType::LINFINITY->value);
$x->addMember($x->getInputName(1),'large',30, 70,100,MemberShipFunctionType::RINFINITY->value);
$x->SetOutputNames(array('risk'));
$x->addMember($x->getOutputName(0),'low',0, 20 ,40 ,MemberShipFunctionType::LINFINITY->value);
$x->addMember($x->getOutputName(0),'normal',20, 50 ,80 ,MemberShipFunctionType::TRIANGLE->value);
$x->addMember($x->getOutputName(0),'high',60,  80 , 100 ,MemberShipFunctionType::RINFINITY->value);
$x->clearRules();
